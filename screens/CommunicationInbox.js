...
export default class CommunicationInbox extends React.Component {
    ...
    renderItem = ({ item }) => {
        return (
            <TouchableOpacity style={styles.list} onPress={() =>
                this.props.navigation.navigate('InboxView', {
                    from: item.fromuser,
                    cc: item.details.cc,
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontSize: 14, color: 'green', marginBottom: 5, marginLeft: 2, flexWrap: "wrap" }}>
                            Sub : {item.subject}   , {item.datetime}
                        </Text>
                    </View>
            ...
            <ScrollView style={{ color: "white", fontSize: 18, textAlign: 'center' }}>
                ...
                <View style={{ marginTop: 10 }}>
                    <Text style={{ color: "#0e9ed8", fontSize: 20, textAlign: 'center', marginBottom: 15, marginTop: 10 }}>
                        <Icon name="mail" size={20} color={'#303f9f'} />  Inbox</Text>
                </View>
