        ...
        return (
            <View style={{ flexDirection: 'row', borderWidth: 0, backgroundColor: 'red', marginTop: 10 }}>
                ...
                <View style={{ flex: 3, backgroundColor: 'white' }}>
                    ...
                    <View style={{ flex: 1, alignItems: 'stretch', justifyContent: 'space-around', backgroundColor: 'yellow' }}>
                        <View style={{ justifyContent: 'space-around', alignItems: 'flex-start', marginLeft: 35 }}>
                            <Text style={{
                                borderWidth: 0, justifyContent: 'space-around', fontSize: 18, alignItems: 'center'
                            }}>
                                <Icon name="user" size={15} /> {this.props.studentName}
                            </Text>
                            {/* <Text style={{ fontSize: 10, color: 'grey' }}>NAme</Text> <Icon name="chevron-down" size={15} />*/}
