...
export default class CommunicationSentbox extends React.Component {
    ...
    renderItem = ({ item }) => {
        return (
            <TouchableOpacity style={styles.list} onPress={() =>
                this.props.navigation.navigate('SentboxView', {
                    To: item.to,
                    cc: item.cc,
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontSize: 14, color: 'green', marginBottom: 5, marginLeft: 2, flexWrap: "wrap" }}>
                            Sub : {item.sub_name}   , {item.datetime}
                        </Text>
                    </View>
    ...
    componentDidMount() {
        return fetch("http://192.168.1.99:8080/digitalcampus.in/ParentzApp/parentsentbox.jsp?username=VR022&schoolcode=VERSION-DEMO&classNo=" + classId + "&section=" + studentSection)
            ...
            .then((responseJson) => {
                ...
                this.setState({
                    dataSource: responseJson.sentbox,
                    isLoading: false
                }, function () { }
                );
            ...
            <ScrollView style={{ color: "white", fontSize: 18, textAlign: 'center' }}>
                ...
                <View style={{ marginTop: 10 }}>
                    <Text style={{ color: "#0e9ed8", fontSize: 20, textAlign: 'center', marginBottom: 15, marginTop: 10 }}>
                        <Icon name="send" size={20} color={'#303f9f'} />  Sentbox</Text>
                </View>
